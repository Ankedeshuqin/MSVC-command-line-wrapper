@rem x64 version of cl.bat. Allows direct use of the MSVC cl command (as cl-x64) in the command line, automatically defines relevant macros and links relevant libraries, and uses the v141_xp toolset, x64 platform during compilation
...
for %%o in (!OBJ_LIST!) do (
    ...
    if not errorlevel 1 (
        set SUBSYS=/SUBSYSTEM:CONSOLE,5.02
